...
const PGN = {
	parse(pgnString, fen) {
		...
		const parsedMoves = this.pegParse(historyString.replace(/\s\s+/g, ' ').replace(/\n/g, " "));
...
(function() {
	...
	/*
	 * Copied from: https://github.com/shaack/cm-pgn/blob/master/src/cm-pgn/parser/pgnParser.js
	 */
